...
lm_fit_nw(lm_5,1)
lm_6 <- lmList(ret_e ~ be+max_ret | ym , data=da_m_lm)
lm_fit_nw(lm_6,2)
lm_7 <- lmList(ret_e ~ be+max_ret+size+BM | ym , data=da_m_lm)
lm_fit_nw(lm_7,4)
lm_8 <- lmList(ret_e ~ be+max_ret+size+BM+mom | ym , data=da_m_lm)
lm_fit_nw(lm_8,5)
lm_9 <- lmList(ret_e ~ be+max_ret+size+BM+mom+ret_tm+illiq | ym , data=da_m_lm)
lm_fit_nw(lm_9,7)

lm_10 <- lmList(ret_e ~ rvol | ym , data=da_m_lm)
lm_fit_nw(lm_10,1)
lm_11 <- lmList(ret_e ~ be+rvol | ym , data=da_m_lm)
lm_fit_nw(lm_11,2)
lm_12 <- lmList(ret_e ~ be+rvol+size+BM | ym , data=da_m_lm)
lm_fit_nw(lm_12,4)
lm_13 <- lmList(ret_e ~ be+rvol+size+BM+mom | ym , data=da_m_lm)
lm_fit_nw(lm_13,5)
lm_14 <- lmList(ret_e ~ be+rvol+size+BM+mom+ret_tm+illiq | ym , data=da_m_lm)
lm_fit_nw(lm_14,7)

lm_15 <- lmList(ret_e ~ rsk | ym , data=da_m_lm)
lm_fit_nw(lm_15,1)
lm_16 <- lmList(ret_e ~ be+rsk | ym , data=da_m_lm)
lm_fit_nw(lm_16,2)
lm_17 <- lmList(ret_e ~ be+rsk+size+BM | ym , data=da_m_lm)
lm_fit_nw(lm_17,4)
lm_18 <- lmList(ret_e ~ be+rsk+size+BM+mom | ym , data=da_m_lm)
lm_fit_nw(lm_18,5)
lm_19 <- lmList(ret_e ~ be+rsk+size+BM+mom+ret_tm+illiq | ym , data=da_m_lm)
lm_fit_nw(lm_19,7)
